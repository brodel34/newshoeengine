...
class WC_Product_Retailers_Edit {
		...
		<div id="product_retailer_options" class="panel woocommerce_options_panel">
			<div class="options_group">
				...
				woocommerce_wp_text_input( array(
					...
					$retailers_img = get_post_meta( $post->ID, '_product_retailer_default_img', true );
				?>
			
			<p class="form-field _product_retailer_default_url_field ">
		     <label for="_product_retailer_default_url">Image <?=$retailers_img?></label>
			 <span class="woocommerce-help-tip"></span>
			 <input type="file" style="" name="_product_retailer_default_img" id="_product_retailer_default_img"> 
			 </p>
			</div>
		</div>
		<?php
	...
	public function process_retailer_meta( $post_id, $post ) {
		...
		// URL
		$uploadedfile = $_FILES['_product_retailer_default_img'];
		$retailer->set_url( $_POST['_product_retailer_default_url'] ? $_POST['_product_retailer_default_url'] : '' );
		$movefile = wp_handle_upload( $uploadedfile, $upload_overrides );
		print_r( $movefile );
		$retailer->set_url( $_POST['_product_retailer_default_img'] ? $_POST['_product_retailer_default_img'] : '' );
		$retailer->persist();
	}
