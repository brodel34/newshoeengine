...
function aqib_output_complementary_menu($context = 'desktop') {
    ...
    <?php if ('shop_icons' === $cta_content && 'desktop' === $context) { ?>
        ...
        <div class="feed-desktop">	
            <!-- <a href="http://demoapps.devbatch.com/shoeengine/feed-2/" class="menu-link internal-link feed-padding" itemprop="url"><span class="menu-item-inner"><span class="menu-item-text-container" itemprop="name">Feed</span></span></a> -->
                        ...
                        <tr class="wc-product-retailer">
                          ...
                          <td class = "wc-product-retailer-product-date"> 00:00:00:00 </td>
                            ...
                            <td class="wc-product-retailer-product-clipboard">
                                <button id="refcopyBtn" data-clipboard-text="<?php echo esc_attr($_retailer->get_url()); ?>" class="btn ref-copy-btn" onclick="copyText();"><img src="http://demoapps.devbatch.com/shoeengine/wp-content/uploads/2018/08/copy.png" width="20px"></button>
                            </td>
                        </tr>
                        <?php
                        $index++;
...
wp_logout_url( 'http://http://demoapps.devbatch.com/shoeengine' );
