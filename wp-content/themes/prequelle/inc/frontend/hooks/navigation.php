            ...
            if (is_user_logged_in()) {
                ...
                if (count($notifications->posts) > 0) {
                    foreach ($notifications->posts as $notify_post) {
                        ...
                        $published_at_bef = strtotime($notify_post->post_date);
                ...
                <?php if ($notificationDisplay > 0) { ?>
                    <div class="cart-container cta-item">
                        <a href="<?php echo get_bloginfo('url'); ?>/notifications" class="bell-cust"><span class="notification_count"><?php echo $notificationDisplay; ?></span></a>
                    </div><!-- .cart-container -->
                <?php } else {
                    ?>
                    <div class="cart-container cta-item">
