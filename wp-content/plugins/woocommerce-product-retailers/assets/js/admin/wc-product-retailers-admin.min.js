jQuery(document).ready(function(a) {
    ...
    a("button.wc-product-retailers-add-retailer-aftermarket").click(function() {
        ...
        d && (a.isArray(d) || (d = d.split(",")), a(d).each(function() {
            a("input#wc-product-retailer-product-url-aftermarket" + this).length || a.get(ajaxurl, {
                ...
                b.length && (a("table.wc-product-retailers_aftermarket > tbody").append('<tr class="wc-product-retailers_aftermarket' + b[0].tab + '"><td class="check-column"><input type="checkbox" name="select" /><input type="hidden" name="_wc_product_retailer_id_' + b[0].tab + '[' + a("table.wc-product-retailers_aftermarket tbody tr").length + ']" value="' + b[0].id + '" /></td><td class="wc-product-retailer-name">' + b[0].name + '</td><td class="wc-product-retailer-product-price"><input type="text" data-post-id="' + b[0].id + '" id="wc-product-retailer-product-price-' + b[0].id + '" name="_wc_product_retailer_product_price_'+b[0].tab+'[' + a("table.wc-product-retailers_aftermarket tbody tr").length + ']" /></td><td class="wc-product-retailer-product-price"><input type="date" data-post-id="' + b[0].id + '" id="wc-product-retailer-product-date-' + b[0].id + '" name="_wc_product_retailer_product_date_'+b[0].tab+'[' + a("table.wc-product-retailers_aftermarket tbody tr").length + ']" /></td><td class="wc-product-retailer-product-price"><input type="text" data-post-id="' + b[0].id + '" id="wc-product-retailer-product-coupon-' + b[0].id + '" name="_wc_product_retailer_product_coupon_'+b[0].tab+'[' + a("table.wc-product-retailers_aftermarket tbody tr").length + ']" /></td><td class="wc-product-retailer-product-price"><input type="text" data-post-id="' + b[0].id + '" id="wc-product-retailer-product-saleprice-' + b[0].id + '" name="_wc_product_retailer_product_saleprice_'+b[0].tab+'[' + a("table.wc-product-retailers_aftermarket tbody tr").length + ']" /></td><td class="wc-product-retailer-product-price"><input type="text" data-post-id="' + b[0].id + '" id="wc-product-retailer-product-color-' + b[0].id + '" name="_wc_product_retailer_product_color_'+b[0].tab+'[' + a("table.wc-product-retailers_aftermarket tbody tr").length + ']" /></td><td class="wc-product-retailer-product-url"><input type="text" data-post-id="' + b[0].id + '" id="wc-product-retailer-product-url-' + b[0].id + '" name="_wc_product_retailer_product_url_'+b[0].tab+'[' + a("table.wc-product-retailers_aftermarket tbody tr").length + ']" value="' + b[0].product_url + '" /></td></tr>'), wc_product_retailers_admin_params.is_wc_gte_3_0 ? c.val(null).trigger("change") : c.select2("val", ""))
            })
        }), b())
    ...
    a("button.wc-product-retailers-add-retailer-raffles").click(function() {
        // alert('3');
        ...
        d && (a.isArray(d) || (d = d.split(",")), a(d).each(function() {
            ...
            function(b) {
                b.length && (a("table.wc-product-retailers_raffles > tbody").append('<tr class="wc-product-retailers_raffles' + b[0].tab + '"><td class="check-column"><input type="checkbox" name="select" /><input type="hidden" name="_wc_product_retailer_id_' + b[0].tab + '[' + a("table.wc-product-retailers_raffles tbody tr").length + ']" value="' + b[0].id + '" /></td><td class="wc-product-retailer-name">' + b[0].name + '</td><td class="wc-product-retailer-product-price"><input type="text" data-post-id="' + b[0].id + '" id="wc-product-retailer-product-price-' + b[0].id + '" name="_wc_product_retailer_product_price_'+b[0].tab+'[' + a("table.wc-product-retailers_raffles tbody tr").length + ']" /></td><td class="wc-product-retailer-product-price"><input type="date" data-post-id="' + b[0].id + '" id="wc-product-retailer-product-date-' + b[0].id + '" name="_wc_product_retailer_product_date_'+b[0].tab+'[' + a("table.wc-product-retailers_raffles tbody tr").length + ']" /></td><td class="wc-product-retailer-product-price"><input type="text" data-post-id="' + b[0].id + '" id="wc-product-retailer-product-coupon-' + b[0].id + '" name="_wc_product_retailer_product_coupon_'+b[0].tab+'[' + a("table.wc-product-retailers_raffles tbody tr").length + ']" /></td><td class="wc-product-retailer-product-price"><input type="text" data-post-id="' + b[0].id + '" id="wc-product-retailer-product-saleprice-' + b[0].id + '" name="_wc_product_retailer_product_saleprice_'+b[0].tab+'[' + a("table.wc-product-retailers_raffles tbody tr").length + ']" /></td><td class="wc-product-retailer-product-price"><input type="text" data-post-id="' + b[0].id + '" id="wc-product-retailer-product-color-' + b[0].id + '" name="_wc_product_retailer_product_color_'+b[0].tab+'[' + a("table.wc-product-retailers_raffles tbody tr").length + ']" /></td><td class="wc-product-retailer-product-url"><input type="text" data-post-id="' + b[0].id + '" id="wc-product-retailer-product-url-' + b[0].id + '" name="_wc_product_retailer_product_url_'+b[0].tab+'[' + a("table.wc-product-retailers_raffles tbody tr").length + ']" value="' + b[0].product_url + '" /></td></tr>'), wc_product_retailers_admin_params.is_wc_gte_3_0 ? c.val(null).trigger("change") : c.select2("val", ""))
            })
    ...
    a("button.wc-product-retailers-add-retailer-wheretobuy").click(function() {
        ...
        d && (a.isArray(d) || (d = d.split(",")), a(d).each(function() {
            a("input#wc-product-retailer-product-url-wheretobuy" + this).length || a.get(ajaxurl, {
                ...
                b.length && (a("table.wc-product-retailers_wheretobuy > tbody").append('<tr class="wc-product-retailer_wheretobuy' + b[0].tab + '"><td class="check-column"><input type="checkbox" name="select" /><input type="hidden" name="_wc_product_retailer_id_' + b[0].tab + '[' + a("table.wc-product-retailers_wheretobuy tbody tr").length + ']" value="' + b[0].id + '" /></td><td class="wc-product-retailer-name">' + b[0].name + '</td><td class="wc-product-retailer-product-price"><input type="text" data-post-id="' + b[0].id + '" id="wc-product-retailer-product-price-' + b[0].id + '" name="_wc_product_retailer_product_price_'+b[0].tab+'[' + a("table.wc-product-retailers_wheretobuy tbody tr").length + ']" /></td><td class="wc-product-retailer-product-price"><input type="date" data-post-id="' + b[0].id + '" id="wc-product-retailer-product-date-' + b[0].id + '" name="_wc_product_retailer_product_date_'+b[0].tab+'[' + a("table.wc-product-retailers_wheretobuy tbody tr").length + ']" /></td><td class="wc-product-retailer-product-price"><input type="text" data-post-id="' + b[0].id + '" id="wc-product-retailer-product-coupon-' + b[0].id + '" name="_wc_product_retailer_product_coupon_'+b[0].tab+'[' + a("table.wc-product-retailers_wheretobuy tbody tr").length + ']" /></td><td class="wc-product-retailer-product-price"><input type="text" data-post-id="' + b[0].id + '" id="wc-product-retailer-product-saleprice-' + b[0].id + '" name="_wc_product_retailer_product_saleprice_'+b[0].tab+'[' + a("table.wc-product-retailers_wheretobuy tbody tr").length + ']" /></td><td class="wc-product-retailer-product-price"><input type="text" data-post-id="' + b[0].id + '" id="wc-product-retailer-product-color-' + b[0].id + '" name="_wc_product_retailer_product_color_'+b[0].tab+'[' + a("table.wc-product-retailers_wheretobuy tbody tr").length + ']" /></td><td class="wc-product-retailer-product-url"><input type="text" data-post-id="' + b[0].id + '" id="wc-product-retailer-product-url-' + b[0].id + '" name="_wc_product_retailer_product_url_'+b[0].tab+'[' + a("table.wc-product-retailers_wheretobuy tbody tr").length + ']" value="' + b[0].product_url + '" /></td></tr>'), wc_product_retailers_admin_params.is_wc_gte_3_0 ? c.val(null).trigger("change") : c.select2("val", ""))
            })
        }), b())
